    ...
    */
    ...
    'providers' => [
        ...
        'openrouter' => [
            ...
            // Read by OpenRouterProvider::defaultTextModel() and friends. Without
            // this block the provider falls back to its own hardcoded defaults
            // and OPENROUTER_MODEL is ignored.
            'models' => [
                'text' => [
                    'default' => env('OPENROUTER_MODEL', 'anthropic/claude-sonnet-5'),
                    'cheapest' => env('OPENROUTER_MODEL_CHEAPEST', 'anthropic/claude-haiku-4.5'),
                    'smartest' => env('OPENROUTER_MODEL_SMARTEST', 'anthropic/claude-opus-5'),
                ],
            ],
        ],
