        ...
        <div className="split">
          <div className="rv">
            ...
            <p className="measure" style={{ color: 'var(--text-muted)' }}>
              The platform now absorbs spikes to <span className="num">71.2M</span> requests a month with zero downtime, across <span className="num">$47.5M</span> in annual GMV.
            </p>
          </div>
          <div className="rv">
